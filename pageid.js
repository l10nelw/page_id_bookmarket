...
if(a[1]=='www.reddit.com'){
	...
	out(document.getElementsByClassName('yt-user-info')[0].textContent+' '+a[a.indexOf('v')+1]+' '+document.getElementById('eow-title').title);
